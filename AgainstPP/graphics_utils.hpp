...
namespace graphics_utils
{
	...
	void allocate_bind_memory (vk::Device graphics_device, const vk::Buffer Buffers, vk::PhysicalDeviceMemoryProperties physical_device_memory_properties, vk::MemoryPropertyFlags required_types, vk::DeviceMemory& out_buffer_memory);
