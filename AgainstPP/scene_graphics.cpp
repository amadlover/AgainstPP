...
egraphics_result scene_graphics::create_renderpass (VkRenderPass* render_pass)
{
...
egraphics_result scene_graphics::create_framebuffers (std::vector<VkFramebuffer>& swapchain_framebuffers, VkRenderPass* render_pass)
{
