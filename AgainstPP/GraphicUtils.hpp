...
public:
	...
	static void CreateShader (vk::Device GraphicsDevice, std::string FilePath, vk::ShaderStageFlagBits ShaderStage, std::vector<vk::PipelineShaderStageCreateInfo>& ShaderStageCreateInfos);
